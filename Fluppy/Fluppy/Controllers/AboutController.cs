...
namespace Fluppy.Controllers
{
    public class AboutController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            model.Blogs = db.Blogs.Include("BlogCategory").Include("Admin").OrderByDescending(o => o.Id).Take(2).ToList();
            model.Teams = db.Teams.Include("TeamSocials").Include("TeamSocials.SocialType").Include("Position").ToList();
